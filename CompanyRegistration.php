                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="txtcountry">
                        ...
                        <div class="col-2">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="txtpname">
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            <label class="label">Company Person Phone Number:</label>
                            <input type="number" class="input--style-4" name="txtCnumber">
                        </div>
                        <div class="p-t-15">
